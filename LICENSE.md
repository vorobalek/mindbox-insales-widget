...
- **Software (Source code)** - the Mindbox / Maestra inSales widget software for transferring data from the User's inSales storefront to CDP Mindbox / Maestra;
...
3.1 The Company provides the Source code of the Software at the following link:

- Repository: [https://github.com/vorobalek/mindbox-insales-private](https://github.com/vorobalek/mindbox-insales-private)

The source code in the repository in the "main" branch is "production ready".

The user understands that the source code in the repository that is not in the "main" branch is not "production ready".
...
- Reading the source code by a person;
- Copying, reproducing the source code "production ready" (Software) inside the User's software (website and/or storefront running on inSales) for integration with the software of the Company - Mindbox / Maestra.
